...
HD_PWD='F:/zdyz_ZYNQ_FPGA/vivado_code/vivado_prj/fft_zishiying_lvboqi/fftjian/fftjian.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_dds_signal_recovery.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_dds_signal_recovery.tcl -notrace
